...
class ShippingV3 extends AbstractStructBase
{
     ...
     * Set esdValue value
     * @param \ChronopostShipping\StructType\EsdValue $esdValue
     * @return \ChronopostShipping\StructType\ShippingV3
     */
