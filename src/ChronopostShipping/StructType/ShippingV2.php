...
class ShippingV2 extends AbstractStructBase
{
     ...
     * Set esdValue value
     * @param \ChronopostShipping\StructType\EsdValue $esdValue
     * @return \ChronopostShipping\StructType\ShippingV2
     */
