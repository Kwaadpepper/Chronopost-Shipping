...
class ShippingMultiParcelV2 extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ChronopostShipping\StructType\SkybillWithDimensionsValueV4[]
     */
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ChronopostShipping\StructType\RecipientLocalValue[]
     */
     ...
     * @param \ChronopostShipping\StructType\SkybillWithDimensionsValueV4[] $skybillValue
     ...
     * @param \ChronopostShipping\StructType\RecipientLocalValue[] $recipientLocalValue
     ...
     * Set esdValue value
     * @param \ChronopostShipping\StructType\EsdValue3 $esdValue
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV2
     */
    ...
    public static function validateShipperValueForArrayConstraintFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV2ShipperValueItem instanceof \ChronopostShipping\StructType\ShipperValueV2) {
    ...
    public static function validateRecipientValueForArrayConstraintFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2RecipientValueItem instanceof \ChronopostShipping\StructType\RecipientValue) {
    ...
    public static function validateRefValueForArrayConstraintFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2RefValueItem instanceof \ChronopostShipping\StructType\RefValue) {
    ...
    public static function validateSkybillValueForArrayConstraintFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2SkybillValueItem instanceof \ChronopostShipping\StructType\SkybillWithDimensionsValueV4) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The skybillValue property can only contain items of type \ChronopostShipping\StructType\SkybillWithDimensionsValueV4, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ChronopostShipping\StructType\SkybillWithDimensionsValueV4 $item
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV2
     */
    public function addToSkybillValue(\ChronopostShipping\StructType\SkybillWithDimensionsValueV4 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ChronopostShipping\StructType\SkybillWithDimensionsValueV4) {
            throw new InvalidArgumentException(sprintf('The skybillValue property can only contain items of type \ChronopostShipping\StructType\SkybillWithDimensionsValueV4, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateScheduledValueForArrayConstraintFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2ScheduledValueItem instanceof \ChronopostShipping\StructType\ScheduledValue) {
    ...
    public static function validateRecipientLocalValueForArrayConstraintFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2RecipientLocalValueItem instanceof \ChronopostShipping\StructType\RecipientLocalValue) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The recipientLocalValue property can only contain items of type \ChronopostShipping\StructType\RecipientLocalValue, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ChronopostShipping\StructType\RecipientLocalValue $item
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV2
     */
    public function addToRecipientLocalValue(\ChronopostShipping\StructType\RecipientLocalValue $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ChronopostShipping\StructType\RecipientLocalValue) {
            throw new InvalidArgumentException(sprintf('The recipientLocalValue property can only contain items of type \ChronopostShipping\StructType\RecipientLocalValue, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateCustomsValueForArrayConstraintFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV2CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV2CustomsValueItem instanceof \ChronopostShipping\StructType\CustomsValue) {
