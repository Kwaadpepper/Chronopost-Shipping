...
class ShippingMultiParcelV6 extends AbstractStructBase
{
     ...
     * Meta information extracted from the WSDL
     * - minOccurs: 0
     * @var \ChronopostShipping\StructType\HeaderValueV2|null
     */
    protected ?\ChronopostShipping\StructType\HeaderValueV2 $headerValue = null;
    /**
     * The shipperValue
     * Meta information extracted from the WSDL
     * - maxOccurs: unbounded
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ChronopostShipping\StructType\SkybillWithDimensionsValueV7[]
     */
     ...
     * @param \ChronopostShipping\StructType\HeaderValueV2 $headerValue
     ...
     * @param \ChronopostShipping\StructType\SkybillWithDimensionsValueV7[] $skybillValue
     ...
     * Set esdValue value
     * @param \ChronopostShipping\StructType\EsdValue3 $esdValue
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV6
     */
     ...
     * @return \ChronopostShipping\StructType\HeaderValueV2|null
     */
    public function getHeaderValue(): ?\ChronopostShipping\StructType\HeaderValueV2
    {
     ...
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV6
     */
    public function setHeaderValue(?\ChronopostShipping\StructType\HeaderValueV2 $headerValue = null): self
    {
    ...
    public static function validateShipperValueForArrayConstraintFromSetShipperValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6ShipperValueItem) {
            ...
            if (!$shippingMultiParcelV6ShipperValueItem instanceof \ChronopostShipping\StructType\ShipperValueV2) {
    ...
    public static function validateRecipientValueForArrayConstraintFromSetRecipientValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6RecipientValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6RecipientValueItem instanceof \ChronopostShipping\StructType\RecipientValueV2) {
    ...
    public static function validateRefValueForArrayConstraintFromSetRefValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6RefValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6RefValueItem instanceof \ChronopostShipping\StructType\RefValueV2) {
     ...
     * @return \ChronopostShipping\StructType\SkybillWithDimensionsValueV7[]
     */
    ...
    public static function validateSkybillValueForArrayConstraintFromSetSkybillValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6SkybillValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6SkybillValueItem instanceof \ChronopostShipping\StructType\SkybillWithDimensionsValueV7) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The skybillValue property can only contain items of type \ChronopostShipping\StructType\SkybillWithDimensionsValueV7, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ChronopostShipping\StructType\SkybillWithDimensionsValueV7 $item
     * @return \ChronopostShipping\StructType\ShippingMultiParcelV6
     */
    public function addToSkybillValue(\ChronopostShipping\StructType\SkybillWithDimensionsValueV7 $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ChronopostShipping\StructType\SkybillWithDimensionsValueV7) {
            throw new InvalidArgumentException(sprintf('The skybillValue property can only contain items of type \ChronopostShipping\StructType\SkybillWithDimensionsValueV7, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateScheduledValueForArrayConstraintFromSetScheduledValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6ScheduledValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6ScheduledValueItem instanceof \ChronopostShipping\StructType\ScheduledValue) {
    ...
    public static function validateRecipientLocalValueForArrayConstraintFromSetRecipientLocalValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6RecipientLocalValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6RecipientLocalValueItem instanceof \ChronopostShipping\StructType\RecipientLocalValueV2) {
    ...
    public static function validateCustomsValueForArrayConstraintFromSetCustomsValue(?array $values = []): string
    {
        ...
        foreach ($values as $shippingMultiParcelV6CustomsValueItem) {
            // validation for constraint: itemType
            if (!$shippingMultiParcelV6CustomsValueItem instanceof \ChronopostShipping\StructType\CustomsValue) {
